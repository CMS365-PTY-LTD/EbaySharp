...
namespace EbaySharp.Controllers
{
    class InventoryController
    {
        ...
        {
            string requestUrl = $"{Constants.API_SERVER_URL}{Constants.DEVELOP.SELLING_APPS.ENDPOINT_URL}{Constants.DEVELOP.SELLING_APPS.LISTING_MANAGEMENT.INVENTORY.ENDPOINT_URL}{Constants.DEVELOP.SELLING_APPS.LISTING_MANAGEMENT.INVENTORY.METHODS.BULK_MIGRATE_LISTING}";
        ...
        {
            string requestUrl = $"{Constants.API_SERVER_URL}{Constants.DEVELOP.SELLING_APPS.ENDPOINT_URL}{Constants.DEVELOP.SELLING_APPS.LISTING_MANAGEMENT.INVENTORY.ENDPOINT_URL}{string.Format(Constants.DEVELOP.SELLING_APPS.LISTING_MANAGEMENT.INVENTORY.METHODS.INVENTORY_ITEMS, limit, offset)}";
        ...
        {
            string requestUrl = $"{Constants.API_SERVER_URL}{Constants.DEVELOP.SELLING_APPS.ENDPOINT_URL}{Constants.DEVELOP.SELLING_APPS.LISTING_MANAGEMENT.INVENTORY.ENDPOINT_URL}{string.Format(Constants.DEVELOP.SELLING_APPS.LISTING_MANAGEMENT.INVENTORY.METHODS.INVENTORY_ITEM, Uri.EscapeDataString(SKU))}";
        ...
        {
            string requestUrl = $"{Constants.API_SERVER_URL}{Constants.DEVELOP.SELLING_APPS.ENDPOINT_URL}{Constants.DEVELOP.SELLING_APPS.LISTING_MANAGEMENT.INVENTORY.ENDPOINT_URL}{string.Format(Constants.DEVELOP.SELLING_APPS.LISTING_MANAGEMENT.INVENTORY.METHODS.OFFERS, Uri.EscapeDataString(SKU))}";
        ...
        {
            string requestUrl = $"{Constants.API_SERVER_URL}{Constants.DEVELOP.SELLING_APPS.ENDPOINT_URL}{Constants.DEVELOP.SELLING_APPS.LISTING_MANAGEMENT.INVENTORY.ENDPOINT_URL}{string.Format(Constants.DEVELOP.SELLING_APPS.LISTING_MANAGEMENT.INVENTORY.METHODS.OFFER, offerId)}";
        ...
        {
            string requestUrl = $"{Constants.API_SERVER_URL}{Constants.DEVELOP.SELLING_APPS.ENDPOINT_URL}{Constants.DEVELOP.SELLING_APPS.LISTING_MANAGEMENT.INVENTORY.ENDPOINT_URL}{Constants.DEVELOP.SELLING_APPS.LISTING_MANAGEMENT.INVENTORY.METHODS.CREATE_OFFER}";
        ...
        {
            string requestUrl = $"{Constants.API_SERVER_URL}{Constants.DEVELOP.SELLING_APPS.ENDPOINT_URL}{Constants.DEVELOP.SELLING_APPS.LISTING_MANAGEMENT.INVENTORY.ENDPOINT_URL}{string.Format(Constants.DEVELOP.SELLING_APPS.LISTING_MANAGEMENT.INVENTORY.METHODS.OFFER, offerId)}/publish";
        ...
        {
            string requestUrl = $"{Constants.API_SERVER_URL}{Constants.DEVELOP.SELLING_APPS.ENDPOINT_URL}{Constants.DEVELOP.SELLING_APPS.LISTING_MANAGEMENT.INVENTORY.ENDPOINT_URL}{string.Format(Constants.DEVELOP.SELLING_APPS.LISTING_MANAGEMENT.INVENTORY.METHODS.OFFER, offerId)}/withdraw";
        ...
        {
            string requestUrl = $"{Constants.API_SERVER_URL}{Constants.DEVELOP.SELLING_APPS.ENDPOINT_URL}{Constants.DEVELOP.SELLING_APPS.LISTING_MANAGEMENT.INVENTORY.ENDPOINT_URL}{string.Format(Constants.DEVELOP.SELLING_APPS.LISTING_MANAGEMENT.INVENTORY.METHODS.LOCATIONS, limit, offset)}";
        ...
        {
            string requestUrl = $"{Constants.API_SERVER_URL}{Constants.DEVELOP.SELLING_APPS.ENDPOINT_URL}{Constants.DEVELOP.SELLING_APPS.LISTING_MANAGEMENT.INVENTORY.ENDPOINT_URL}{string.Format(Constants.DEVELOP.SELLING_APPS.LISTING_MANAGEMENT.INVENTORY.METHODS.LOCATION, merchantLocationKey)}";
        ...
        {
            string requestUrl = $"{Constants.API_SERVER_URL}{Constants.DEVELOP.SELLING_APPS.ENDPOINT_URL}{Constants.DEVELOP.SELLING_APPS.LISTING_MANAGEMENT.INVENTORY.ENDPOINT_URL}{string.Format(Constants.DEVELOP.SELLING_APPS.LISTING_MANAGEMENT.INVENTORY.METHODS.LOCATION, inventoryLocation.MerchantLocationKey)}";

...
namespace EbaySharp.Controllers
{
    class FulfillmentController
    {
        ...
        {
            string requestUrl = $"{Constants.API_SERVER_URL}{Constants.DEVELOP.SELLING_APPS.ENDPOINT_URL}{Constants.DEVELOP.SELLING_APPS.ORDERS_MANAGEMENT.FULFILLEMENT.ENDPOINT_URL}{Constants.DEVELOP.SELLING_APPS.ORDERS_MANAGEMENT.FULFILLEMENT.ORDER.ENDPOINT_URL}{string.Format(Constants.DEVELOP.SELLING_APPS.ORDERS_MANAGEMENT.FULFILLEMENT.ORDER.SHIPPING_FULFILLEMENT.METHODS.GET_SHIPPING_FULFILLEMENT, orderId, fulfillmentId)}";
        ...
        {
            string requestUrl = $"{Constants.API_SERVER_URL}{Constants.DEVELOP.SELLING_APPS.ENDPOINT_URL}{Constants.DEVELOP.SELLING_APPS.ORDERS_MANAGEMENT.FULFILLEMENT.ENDPOINT_URL}{Constants.DEVELOP.SELLING_APPS.ORDERS_MANAGEMENT.FULFILLEMENT.ORDER.ENDPOINT_URL}{string.Format(Constants.DEVELOP.SELLING_APPS.ORDERS_MANAGEMENT.FULFILLEMENT.ORDER.METHODS.GET_ORDERS_BY_ORDER_NUMBERS, string.Join(',', orderNumbers))}";
        ...
        {
            string requestUrl = $"{Constants.API_SERVER_URL}{Constants.DEVELOP.SELLING_APPS.ENDPOINT_URL}{Constants.DEVELOP.SELLING_APPS.ORDERS_MANAGEMENT.FULFILLEMENT.ENDPOINT_URL}{Constants.DEVELOP.SELLING_APPS.ORDERS_MANAGEMENT.FULFILLEMENT.ORDER.ENDPOINT_URL}{string.Format(Constants.DEVELOP.SELLING_APPS.ORDERS_MANAGEMENT.FULFILLEMENT.ORDER.METHODS.GET_ORDER, orderNumber)}";
        ...
        {
            string requestUrl = $"{Constants.API_SERVER_URL}{Constants.DEVELOP.SELLING_APPS.ENDPOINT_URL}{Constants.DEVELOP.SELLING_APPS.ORDERS_MANAGEMENT.FULFILLEMENT.ENDPOINT_URL}{Constants.DEVELOP.SELLING_APPS.ORDERS_MANAGEMENT.FULFILLEMENT.ORDER.ENDPOINT_URL}" +
                $"{string.Format(Constants.DEVELOP.SELLING_APPS.ORDERS_MANAGEMENT.FULFILLEMENT.ORDER.METHODS.GET_ORDERS_BY_FILTER, filter, limit, offset)}";
            return await new RequestExecuter().ExecuteGetRequest<Orders>(requestUrl, $"Bearer {accessToken}");
        }

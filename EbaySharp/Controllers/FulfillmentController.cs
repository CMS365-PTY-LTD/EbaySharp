...
namespace EbaySharp.Controllers
{
    class FulfillmentController
    {
        ...
        {
            string requestUrl = $"{Constants.SERVER_URL}{Constants.SELL.FULFILLEMENT.ENDPOINT_URL}{Constants.SELL.FULFILLEMENT.ORDER.ENDPOINT_URL}{string.Format(Constants.SELL.FULFILLEMENT.ORDER.SHIPPING_FULFILLEMENT.METHODS.GET_SHIPPING_FULFILLEMENT, orderId, fulfillmentId)}";
        ...
        {
            string requestUrl = $"{Constants.SERVER_URL}{Constants.SELL.FULFILLEMENT.ENDPOINT_URL}{Constants.SELL.FULFILLEMENT.ORDER.ENDPOINT_URL}{string.Format(Constants.SELL.FULFILLEMENT.ORDER.SHIPPING_FULFILLEMENT.METHODS.CREATE_SHIPPING_FULFILLEMENTS, orderId)}";
        ...
        {
            string requestUrl = $"{Constants.SERVER_URL}{Constants.SELL.FULFILLEMENT.ENDPOINT_URL}{Constants.SELL.FULFILLEMENT.ORDER.ENDPOINT_URL}{string.Format(Constants.SELL.FULFILLEMENT.ORDER.METHODS.GET_ORDER, orderNumber)}";
